# -*- coding: utf-8 -*-
"""
Created on Sun Dec 15 22:44:33 2019
...
#split channels - no need to reshape data with .tif files
    channel1 = mydata[0]
    channel2 = mydata[1]
...
# NOTE: Includes pixel sampling factors;
    ...
    distancemap2 = ndi.distance_transform_edt(
        ~mask2,
        sampling=[xymicsperpix, xymicsperpix],
    )
...
#channel1 overlay images:
    ...
    plt.contour(mask1, levels=[0.5], colors=['r'])
...
#channel2 overlay images:
    ...
    plt.contour(mask2, levels=[0.5], colors=['r'])
...
# in the terminal...
    ...
    print("Number of objects in mask2:", num_objects2)
...
# First, let's create an empty list using []
    distances_list = []
    dist_stats_list=[['filename',
                      'PDmin',
                      'PDmax',
                      'PDmean',
                      'PDmedian',
                      'total number of channel 1 obj perimeter pixels']]
